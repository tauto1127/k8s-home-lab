...
1. ESO controller: outer Kustomization + HelmReleaseをfalse。timeout 5m。Deployment/CRDがReadyでなければ即停止しcommit revert。個別の証跡と手順は`docs/flux-eso-controller-activation-runbook.md`。
